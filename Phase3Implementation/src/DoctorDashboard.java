...
public class DoctorDashboard {
    ...
    public static void display(Stage window, User user) {
        ...
        if (user instanceof Doctor) {
            ...
            appointmentsData.addAll(doctor.getAppointments());
        }
    ...
    private static ObservableList<Appointment> getDoctorAppointments(String doctorUsername) {
        
        return 
    }

    private static void showPrescriptionForm(Stage window, String doctorUsername) { // Assume doctorUsername is passed to identify the doctor
        VBox layout = new VBox(10);
        ...
        submitButton.setOnAction(e -> {
            ...
            window.setScene(/* previous scene or refresh current scene */); // Switch back or indicate success
        });
    ...
    public static void displayAppointmentForm(Stage window, String doctorUsername) {
        ...
        submitButton.setOnAction(e -> {
            ...
            if(patientUsernameField.getText().isEmpty() || datePicker.getValue() == null) {
                ...
                Appointment appointment = new Appointment(doctorUsername, patientUsername, date, time, purpose);
            ...
            Doctor doctor = (Doctor) users.get(doctorUsername);
            Patient patient = (Patient) users.get(patientUsername);

            if (doctor != null && patient != null) {
                doctor.addAppointment(appointment);
                // Assuming patients also need to track their appointments
                // patient.addAppointment(appointment); // maybe add a similar method to Patient class
            ...
            // Reset form fields or switch scenes as necessary
        });       
